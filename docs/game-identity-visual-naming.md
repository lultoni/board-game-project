# Design Language — Future Visual & Identity Direction

*Gathering insights for the art/visual design phase (Phase B per project timeline). Not active work — collecting decisions and constraints as they emerge during mechanical design.*
...
**Champions are blank slates.** Their identity emerges from the skills you equip on them — not from pre-assigned names, classes, or artwork. This "mental freedom to do anything" is a design value, not a gap to fill.

The visual/naming phase should *reinforce* this, not contradict it.

---

## Emergent Identity via Skills
...
- Pieces need visible, readable skill slots (cards? tokens? inserts?)
- The slot system should be quick to set up and quick to read mid-game from across the table
- Consider: does the piece *change appearance* based on equipped skills? (colour-coded tokens, art overlays, etc.)
- Injured state needs a clear physical indicator (flip? marker? rotation?)

---

## Timeline

This work begins after v1 mechanical design is complete (estimated Phase B, ~2027 per project timeline). Collected here so insights aren't lost between now and then.
